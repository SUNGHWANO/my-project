...
drag.className='scrollsidebar-drag';if(params.draggable)drag.className+=' scrollsidebar-cursor-drag';track.appendChild(drag);if(params.hide)track.style.opacity=0;var te=swiper.touchEvents
